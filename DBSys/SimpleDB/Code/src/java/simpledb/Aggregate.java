...
public class Aggregate extends Operator {
    ...
    public void open() throws NoSuchElementException, DbException,
    	...
    	try {
	    	...
	    	if (child.getTupleDesc().getFieldType(afield) == Type.INT_TYPE){
	    		//Int aggregator
	    		Aggregator agg = new IntegerAggregator(gfield, type, afield, aop);
	    	...
	    	if (child.getTupleDesc().getFieldType(afield) == Type.STRING_TYPE){
	    		//String aggregator
	    		Aggregator agg = new StringAggregator(gfield, type, afield, aop);
    ...
    public TupleDesc getTupleDesc() {
    	if (gfield == -1) {
    		...
    		return new TupleDesc(new Type[] {Type.INT_TYPE, child.getTupleDesc().getFieldType(gfield)}, new String[] {aggregateFieldName(), groupFieldName()} );
    	}
    }
