...
public class HeapPage implements Page {
    ...
    */
    ...
    public void deleteTuple(Tuple t) throws DbException {
        ...
        if (rid == null) {
        	throw new DbException("Invalid record ID given.");
        }
    ...
    public void insertTuple(Tuple t) throws DbException {
        ...
        if (!t.getTupleDesc().equals(td)) {
            throw new DbException("The tuple's descriptor is not the same as the one of the page.");
        }

        //Search for the first empty slot
        int i = 0;
        
        while (isSlotUsed(i) && i < numSlots) {
        	i += 1;
        }
        
        //We checked that there is an empty slot before so i must be the index of an empty slot, no need for further checks
        markSlotUsed(i, true);
    ...
    private void markSlotUsed(int i, boolean value) {
    	if (i < numSlots) {
	    	...
	    	if (value) {
	    		header[byteN] = (byte)(header[byteN] | (1 << bitN));
	    	} else {
	    		header[byteN] = (byte)(header[byteN] & ~(1 << bitN));
	    	}
    	}
