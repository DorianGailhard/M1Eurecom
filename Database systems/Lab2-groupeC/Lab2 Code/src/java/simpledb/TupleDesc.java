...
public class TupleDesc implements Serializable {
    ...
    /**
     * Add a prefix before each field name.
     * @param str
     *            the prefix.
     * @return The tupleDesc with the prefix
     */
    public TupleDesc addPrefix(String str) {
    	int tdLen = numFields();

            Type[] typeAr = new Type[tdLen];
            String[] fieldAr = new String[tdLen];

            for (int i = 0; i < tdLen; i++) {
                typeAr[i] = items.get(i).fieldType;
                fieldAr[i] = str + items.get(i).fieldName;
            }
