...
public class BufferPool {
    ...
    public synchronized void flushAllPages() throws IOException {
    	for (Page page : bufferPool.pageBuffer) {
    ...
    */
    ...
    private synchronized  void flushPage(PageId pid) throws IOException {
    	if(pid != null){
        	...
        	hf.writePage(bufferPool.get(pid));
        }
    }
 ...
 private static class PageBufferPool {
    ...
    private final ConcurrentHashMap<Page, Long> pageAccessTime;
    ...
    public PageBufferPool(int size) {
      ...
      this.pageAccessTime = new ConcurrentHashMap<Page, Long>(size);
    }
    ...
    public Page get(PageId id) {
      Page page = pageIdToPage.get(id);
      pageAccessTime.put(page, System.currentTimeMillis());
    ...
    public Page evictPage() {
      ...
      if (bufferSize > 0 && bufferSize == capacity) {
    	  //Find the least recent access
    	  Long min = null;
    	  Page page = null;
    	  
    	  for (Map.Entry<Page, Long> entry : pageAccessTime.entrySet()) {
