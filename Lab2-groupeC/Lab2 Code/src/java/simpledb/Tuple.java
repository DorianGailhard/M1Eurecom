...
public class Tuple implements Serializable {
    ...
    public static Tuple merge(Tuple tuple1, Tuple tuple2) {
    	Tuple result = new Tuple(TupleDesc.merge(tuple1.getTupleDesc(),tuple2.getTupleDesc()));
    	int tuple1Length = tuple1.getTupleDesc().numFields();
    	...
    	for (int i=0; i<tuple2.getTupleDesc().numFields();i++) {
    		result.setField(tuple1Length + i, tuple2.getField(i));
    	}
